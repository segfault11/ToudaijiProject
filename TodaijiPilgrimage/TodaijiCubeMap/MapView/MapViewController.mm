...
<CvVideoCameraDelegate,CLLocationManagerDelegate>
{
    ...
    // Navi UI
    IBOutlet UIImageView *imageViewMap;
    IBOutlet UIButton *btnRyoben;
    IBOutlet UIButton *btnKaigen;
    IBOutlet UIButton *btnHeian;
    IBOutlet UIButton *btnKamakura;
    IBOutlet UIButton *btnRenben;
    IBOutlet UIButton *btnZoutyouten;
    IBOutlet UIButton *btnKomokuten;
    IBOutlet UIButton *btnTamokuten;
    IBOutlet UIButton *btnJikokuten;
    IBOutlet UIButton *btnDaibutsu;
